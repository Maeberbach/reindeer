...
To open it, go to https://reindeer-fair-play.onrender.com and use the "Import from Reindeer Wishes" option. You will also need a license key from ${ownerName} — they will share it with you separately.
...
This package was prepared on ${new Date().toLocaleDateString('en-US', { dateStyle: 'long' })}.`;
  ...
  if ($('#optDiscovery').checked) {
    triggerDownload(`${API}/api/export/bundle`);
    const discoveryUrl = 'https://reindeer-discovery.onrender.com';
